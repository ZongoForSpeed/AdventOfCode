...
public final class Day11 {
    ...
    static int adjacentOccupiedSeats(char[][] grid, int x0, int y0, boolean deepSearch) {
    ...
    /// occupied?
    static long simulationSeatingSystem(char[][] grid, boolean deepSearch) {
        boolean stable;
        do {
