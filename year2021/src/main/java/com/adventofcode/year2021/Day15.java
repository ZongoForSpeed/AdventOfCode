...
public final class Day15 {
     ...
     */
    static long chiton(Scanner scanner) {
        return chiton(scanner, UnaryOperator.identity());
    }

    static IntegerMap repeat(IntegerMap map) {
     ...
     */
    static long chiton(Scanner scanner, UnaryOperator<IntegerMap> mapFunction) {
