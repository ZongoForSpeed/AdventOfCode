...
class Day03Test {
    ...
    private static int countTrianglesPartOne(Scanner scanner) {
        int count = 0;
    ...
    private static int countTrianglesPartTwo(Scanner scanner) {
    ...
    void inputExample() {
        ...
        int count = countTrianglesPartTwo(new Scanner(input));
    ...
    void inputPartOne() throws IOException {
        try (InputStream is = Day03Test.class.getResourceAsStream("/2016/day/3/input")) {
            Scanner scanner = new Scanner(Objects.requireNonNull(is));
            assertThat(countTrianglesPartOne(scanner)).isEqualTo(1032);
        }
    }
    ...
    void inputPartTwo() throws IOException {
        try (InputStream is = Day03Test.class.getResourceAsStream("/2016/day/3/input")) {
            Scanner scanner = new Scanner(Objects.requireNonNull(is));
            assertThat(countTrianglesPartTwo(scanner)).isEqualTo(1838);
