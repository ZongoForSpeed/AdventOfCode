...
class Day08Test {
    ...
    private static BooleanMap buildScreen(Scanner scanner, int xMax, int yMax) {
        BooleanMap booleanMap = new BooleanMap(xMax, yMax);
    ...
    void inputExample() {
        ...
        BooleanMap charMap = buildScreen(scanner, 7, 3);
    ...
    void inputPartOne() throws IOException {
        try (InputStream is = Day08Test.class.getResourceAsStream("/2016/day/8/input")) {
            Scanner scanner = new Scanner(Objects.requireNonNull(is));
            BooleanMap booleanMap = buildScreen(scanner, 50, 6);
            assertThat(booleanMap.cardinality()).isEqualTo(121);
        }
    }
