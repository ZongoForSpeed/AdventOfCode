...
class Day11Test {
    ...
    void inputExample() throws IOException {
        ...
        long algorithm = AStar.algorithmHeuristic(State::nextStates, (a, b) -> 1L, State::heuristic, start, endState);
        assertThat(algorithm).isEqualTo(11);
    }
    ...
    void inputPartOne() throws IOException {
        ...
        var algorithm = AStar.algorithmHeuristic(State::nextStates, (a, b) -> 1L, State::heuristic, start, endState);

        assertThat(algorithm).isEqualTo(33);
    }
    ...
    void inputPartTwo() throws IOException {
        ...
        assertThat(algorithm).isEqualTo(57);
    }
    ...
    record State(int elevator, Floor first, Floor second, Floor third, Floor fourth) {
        ...
        private State nextState(int destination, LongPair moved) {
            ...
            return new State(
                    destination,
                    destination == 1 ? newDestination : elevator == 1 ? newCurrent : first,
                    destination == 2 ? newDestination : elevator == 2 ? newCurrent : second,
                    destination == 3 ? newDestination : elevator == 3 ? newCurrent : third,
                    destination == 4 ? newDestination : elevator == 4 ? newCurrent : fourth);
        }
