...
class Day05Test {
    ...
    private static String findPasswordPartOne(String doorID) {
    ...
    private static String findPasswordPartTwo(String doorID) {
    ...
    @Test
    void inputExample() {
        assertThat(findPasswordPartOne("abc")).isEqualTo("18f47a30");
        assertThat(findPasswordPartTwo("abc")).isEqualTo("05ace8e3");
    }
    ...
    @Test
    void inputPartOne() {
        assertThat(findPasswordPartOne("cxdnnyjw")).isEqualTo("f77a0e6e");
    }
    ...
    @Test
    void inputPartTwo() {
        assertThat(findPasswordPartTwo("cxdnnyjw")).isEqualTo("999828ec");
    }
