...
class Day21Test {
    ...
    private static String scramblingFunction(Scanner scanner, String letters) {
        List<String> operations = readOperations(scanner);

        return scramblingFunction(operations, letters);
    }

    private static String unscramblingFunction(Scanner scanner, String password) {
        List<String> operations = readOperations(scanner);
    ...
    void inputExample() {
        ...
        assertThat(scramblingFunction(new Scanner(input), "abcde")).isEqualTo("decab");
    }
    ...
    void inputPartOne() throws IOException {
        try (InputStream is = Day21Test.class.getResourceAsStream("/2016/day/21/input")) {
            Scanner scanner = new Scanner(Objects.requireNonNull(is));
            assertThat(scramblingFunction(scanner, "abcdefgh")).isEqualTo("gcedfahb");
    ...
    void inputPartTwo() throws IOException {
        try (InputStream is = Day21Test.class.getResourceAsStream("/2016/day/21/input")) {
            Scanner scanner = new Scanner(Objects.requireNonNull(is));
            assertThat(unscramblingFunction(scanner, "fbgdceah")).isEqualTo("hegbdcfa");
