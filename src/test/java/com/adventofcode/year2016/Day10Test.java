...
class Day10Test {
    ...
    void inputPartOne() throws IOException {
        try (InputStream is = Day10Test.class.getResourceAsStream("/2016/day/10/input")) {
            Scanner scanner = new Scanner(Objects.requireNonNull(is));
            BalanceBots balanceBots = new BalanceBots();
            balanceBots.runBalanceBots(scanner);
            assertThat(balanceBots.findChips(IntegerPair.of(17, 61))).isEqualTo(56);
        }
    }
    ...
    void inputPartTwo() throws IOException {
        try (InputStream is = Day10Test.class.getResourceAsStream("/2016/day/10/input")) {
            ...
            BalanceBots balanceBots = new BalanceBots();
            balanceBots.runBalanceBots(scanner);
            assertThat(balanceBots.getOutput012()).isEqualTo(7847);
        }
    }

    private static class BalanceBots {
