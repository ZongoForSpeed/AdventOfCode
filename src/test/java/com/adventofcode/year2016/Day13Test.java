...
class Day13Test {
    ...
    private static List<Point2D> neighbours(Point2D p, int favoriteNumber) {
    ...
    public static <E> long algorithm(Function<E, Collection<E>> graph, E start, long distance) {
    ...
    void inputExample() throws IOException {
        ...
        Point2D end = Point2D.of(7, 4);

        long path = AStar.algorithm(p -> neighbours(p, favoriteNumber), (a, b) -> 1L, start, end);
        assertThat(path).isEqualTo(11);
    }
    ...
    void inputPartTwo() throws IOException {
        ...
        long path = algorithm(p -> neighbours(p, favoriteNumber), start, 50);
