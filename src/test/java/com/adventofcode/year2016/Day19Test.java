...
class Day19Test {
    ...
    void inputExample() throws IOException {
        assertThat(getLastElfPartOne(5)).isEqualTo(3);
        assertThat(getLastElfPartTwo(5)).isEqualTo(2);
    }

    private int getLastElfPartOne(int elves) {
    ...
    private int getLastElfPartTwo(int elves) {
        ElvesTable<Integer> table = new ElvesTable<>();
        for (int elf = 1; elf <= elves; ++elf) {
            table.addLast(elf);
        }
    ...
    void inputPartOne() throws IOException {
        assertThat(getLastElfPartOne(3014603)).isEqualTo(1834903);
    }
    ...
    void inputPartTwo() throws IOException {
        assertThat(getLastElfPartTwo(3014603)).isEqualTo(1420280);
    }
