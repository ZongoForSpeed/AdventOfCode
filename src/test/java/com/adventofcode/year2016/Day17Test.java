...
class Day17Test {
    ...
    private static String findShortestPath(String passcode) {
        List<String> paths = findAllPaths(passcode);
        return paths.get(0);
    }

    private static String findLongestPath(String passcode) {
        List<String> paths = findAllPaths(passcode);
    ...
    void inputExample() throws IOException {
        assertThat(findShortestPath("ihgpwlah")).isEqualTo("DDRRRD");
        assertThat(findShortestPath("kglvqrro")).isEqualTo("DDUDRLRRUDRD");
        assertThat(findShortestPath("ulqzkmiv")).isEqualTo("DRURDRUDDLLDLUURRDULRLDUUDDDRR");

        assertThat(findLongestPath("ihgpwlah")).hasSize(370);
        assertThat(findLongestPath("kglvqrro")).hasSize(492);
        assertThat(findLongestPath("ulqzkmiv")).hasSize(830);
    }
    ...
    void inputPartOne() throws IOException {
        assertThat(findShortestPath("ioramepc")).isEqualTo("RDDRULDDRR");
    }
    ...
    void inputPartTwo() throws IOException {
        assertThat(findLongestPath("ioramepc")).hasSize(766);
    }
