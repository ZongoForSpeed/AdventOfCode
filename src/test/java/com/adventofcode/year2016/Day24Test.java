...
class Day24Test {
    ...
    private static long computeMinSteps(Scanner scanner, boolean addOrigin) {
    ...
    void inputExample() {
        ...
        long minSteps = computeMinSteps(scanner, false);
    ...
    void inputPartOne() throws IOException {
        try (InputStream is = Day24Test.class.getResourceAsStream("/2016/day/24/input")) {
            Scanner scanner = new Scanner(Objects.requireNonNull(is));

            long minSteps = computeMinSteps(scanner, false);

            LOGGER.info("minSteps: {}", minSteps);
            assertThat(minSteps).isEqualTo(470);
        }
    }
    ...
    void inputPartTwo() throws IOException {
        try (InputStream is = Day24Test.class.getResourceAsStream("/2016/day/24/input")) {
            ...
            long minSteps = computeMinSteps(scanner, true);

            LOGGER.info("minSteps: {}", minSteps);
            assertThat(minSteps).isEqualTo(720);
        }
    }
}
