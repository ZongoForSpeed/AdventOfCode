...
class Day14Test {
    ...
    private static String stretchMD5(String input) {
        int count = 2016;
        do {
    ...
    private static int find64thKey(String salt, Function<String, String> hashingFunction) {
    ...
    void inputExample() throws IOException {
        assertThat(stretchMD5("abc0")).isEqualTo("a107ff634856bb300138cac6568c0f24");
        assertThat(find64thKey("abc", DigestUtils::md5Hex)).isEqualTo(22728);
        assertThat(find64thKey("abc", Day14Test::stretchMD5)).isEqualTo(22551);
    ...
    void inputPartOne() throws IOException {
        assertThat(find64thKey("ihaygndm", DigestUtils::md5Hex)).isEqualTo(15035);
    }
    ...
    void inputPartTwo() throws IOException {
        assertThat(find64thKey("ihaygndm", Day14Test::stretchMD5)).isEqualTo(19968);
    }
