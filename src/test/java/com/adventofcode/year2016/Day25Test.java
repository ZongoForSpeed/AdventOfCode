...
import com.adventofcode.Assembunny;
...
class Day25Test {
    ...
    private static int findClockSignal(Scanner scanner) {
    ...
    void inputPartOne() throws IOException {
        try (InputStream is = Day25Test.class.getResourceAsStream("/2016/day/25/input")) {
            Scanner scanner = new Scanner(Objects.requireNonNull(is));

            int clockSignal = findClockSignal(scanner);
            assertThat(clockSignal).isEqualTo(189);
        }
    }
