...
class Day11Test {
    private static long encode(String password) {
        return password.chars().mapToLong(c -> c - 'a').reduce(0L, (a, b) -> a * 26 + b);
    }

    private static String decode(long code) {
    ...
    @Test
    void inputExample() {
        assertThat(validatePassword("hijklmmn")).isFalse();
        assertThat(validatePassword("abbceffg")).isFalse();
        assertThat(validatePassword("abbcegjk")).isFalse();
        assertThat(validatePassword("abcdffaa")).isTrue();
        assertThat(validatePassword("ghjaabcc")).isTrue();
        assertThat(decode(encode("abcdefgh"))).isEqualTo("abcdefgh");
    ...
    void inputPartOne() throws IOException {
        assertThat(nextPassword("cqjxjnds")).isEqualTo("cqjxxyzz");
    }
    ...
    void inputPartTwo() throws IOException {
        assertThat(nextPassword("cqjxxyzz")).isEqualTo("cqkaabcc");
    }
}
