...
class Day16Test {
    ...
    Day16Test() {
        Scanner scannerSue = new Scanner("""
                children: 3
                cats: 7
                samoyeds: 2
                pomeranians: 3
    ...
    private static List<Pair<Integer, Map<Compounds, Integer>>> readInput(Scanner scanner) {
    ...
    private Integer findAuntSuePartOne(Scanner scanner) {
        ...
        for (Pair<Integer, Map<Compounds, Integer>> pair : sues) {
            ...
            for (Map.Entry<Compounds, Integer> entry : pair.getRight().entrySet()) {
                Integer integer = sue.get(entry.getKey());
    ...
    private Integer findAuntSuePartTwo(Scanner scanner) {
        List<Pair<Integer, Map<Compounds, Integer>>> sues = readInput(scanner);
    ...
    void inputPartOne() throws IOException {
        try (InputStream is = Day16Test.class.getResourceAsStream("/2015/day/16/input")) {
            Scanner scanner = new Scanner(Objects.requireNonNull(is));
            assertThat(findAuntSuePartOne(scanner)).isEqualTo(103);
        }
    }
    ...
    void inputPartTwo() throws IOException {
        try (InputStream is = Day16Test.class.getResourceAsStream("/2015/day/16/input")) {
            Scanner scanner = new Scanner(Objects.requireNonNull(is));
            assertThat(findAuntSuePartTwo(scanner)).isEqualTo(405);
        }
    }
