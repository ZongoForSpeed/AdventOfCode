...
class Day19Test {
    ...
    private static List<String> readMolecule(String molecule) {
    ...
    private static Set<List<String>> findReplacements(Scanner scanner) {
    ...
    private static long findMedicine(Scanner scanner) {
    ...
    private static Set<List<String>> findNextMolecules(Map<String, List<List<String>>> replacements, List<String> medicineMolecule) {
    ...
    @Test
    void inputExample() {
        assertThat(findReplacements(new Scanner("""
                H => HO
                H => OH
                O => HH
        ...
        assertThat(findMedicine(new Scanner("""
                e => H
                e => O
                H => HO
                H => OH
    ...
    void inputPartOne() throws IOException {
        try (InputStream is = Day19Test.class.getResourceAsStream("/2015/day/19/input")) {
            Scanner scanner = new Scanner(Objects.requireNonNull(is));

            assertThat(findReplacements(scanner)).hasSize(535);
        }
    }
    ...
    void inputPartTwo() throws IOException {
        try (InputStream is = Day19Test.class.getResourceAsStream("/2015/day/19/input")) {
            Scanner scanner = new Scanner(Objects.requireNonNull(is));
            assertThat(findMedicine(scanner)).isEqualTo(212);
        }
    }
}
