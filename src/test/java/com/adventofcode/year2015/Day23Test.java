...
class Day23Test {
    ...
    private static Map<Character, Long> runInstructions(Scanner scanner, int initialValue) {
    ...
    void inputExample() {
        ...
        Map<Character, Long> registers = runInstructions(scanner, 0);
    ...
    void inputPartOne() throws IOException {
        try (InputStream is = Day23Test.class.getResourceAsStream("/2015/day/23/input")) {
    ...
    void inputPartTwo() throws IOException {
        try (InputStream is = Day23Test.class.getResourceAsStream("/2015/day/23/input")) {
            Scanner scanner = new Scanner(Objects.requireNonNull(is));
            Map<Character, Long> registers = runInstructions(scanner, 1);
