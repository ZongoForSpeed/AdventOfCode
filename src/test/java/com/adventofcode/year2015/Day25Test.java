...
class Day25Test {
    ...
    private static long findCode(int row, int column) {
        long code = 20151125;
        for (int i = 1; ; ++i) {
            for (int iColumn = 1; iColumn <= i; ++iColumn) {
                int iRow = i - iColumn + 1;
                LOGGER.trace("Number at ({},{}) is {}", iRow, iColumn, code);
    ...
    @Test
    void inputExample() {
        assertThat(findCode(6, 6)).isEqualTo(27995004);
    }
     ...
     * the right. This process repeats until the infinite paper is covered. So,
    ...
    void inputPartOne() throws IOException {
        ...
        assertThat(findCode(2978, 3083)).isEqualTo(2650453);
    }
