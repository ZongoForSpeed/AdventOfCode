...
class Day24Test {
    ...
    private static long findQuantumEntanglement(Scanner scanner, int groups) {
    ...
    void inputExample() {
        ...
        assertThat(findQuantumEntanglement(new Scanner(input), 3)).isEqualTo(99);
        assertThat(findQuantumEntanglement(new Scanner(input), 4)).isEqualTo(44);
    }
    ...
    void inputPartOne() throws IOException {
        try (InputStream is = Day24Test.class.getResourceAsStream("/2015/day/24/input")) {
            Scanner scanner = new Scanner(Objects.requireNonNull(is));

            assertThat(findQuantumEntanglement(scanner, 3)).isEqualTo(11846773891L);
        }
    }
    ...
    void inputPartTwo() throws IOException {
        try (InputStream is = Day24Test.class.getResourceAsStream("/2015/day/24/input")) {
            ...
            assertThat(findQuantumEntanglement(scanner, 4)).isEqualTo(80393059);
        }
    }
}
