...
public class Day21Test {
    ...
    private static long playPartOne(Scanner scanner) {
    ...
    private static long playPartTwo(Scanner scanner) {
        Map<String, Player> players = readPlayer(scanner);
    ...
    void inputExample() {
        ...
        assertThat(playPartOne(new Scanner(input))).isEqualTo(739785);
        assertThat(playPartTwo(new Scanner(input))).isEqualTo(444356092776315L);
    }
    ...
    void inputPartOne() throws IOException {
        try (InputStream is = Day21Test.class.getResourceAsStream("/2021/day/21/input")) {
            ...
            assertThat(playPartOne(scanner)).isEqualTo(503478);
        }
    }
    ...
    void inputPartTwo() throws IOException {
        try (InputStream is = Day21Test.class.getResourceAsStream("/2021/day/21/input")) {
            Scanner scanner = new Scanner(Objects.requireNonNull(is));
            assertThat(playPartTwo(scanner)).isEqualTo(716241959649754L);
        }
    }
    ...
    record Player(String name, int position, int score) {
        ...
        public Player play(int d1, int d2, int d3) {
            ...
            // LOGGER.info("Player {} rolls {}+{}+{} and moves to space {} for a total score of {}", name, d1, d2, d3, nextPosition, nextScore);
