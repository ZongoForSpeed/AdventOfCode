...
public class Day24Test {
    ...
    private static long aluPartOne(Scanner scanner) {
    ...
    private static long aluPartTwo(Scanner scanner) {
        Int2ObjectMap<IntegerPair> criteria = readCriteria(scanner);
        IntList order = new IntArrayList(IntStream.range(1, 10).toArray());
    ...
    void inputPartOne() throws IOException {
        try (InputStream is = Day24Test.class.getResourceAsStream("/2021/day/24/input")) {
            ...
            assertThat(aluPartOne(scanner)).isEqualTo(39924989499969L);
        }
    }
    ...
    void inputPartTwo() throws IOException {
        try (InputStream is = Day24Test.class.getResourceAsStream("/2021/day/24/input")) {
            Scanner scanner = new Scanner(Objects.requireNonNull(is));
            assertThat(aluPartTwo(scanner)).isEqualTo(16811412161117L);
        }
    }
