...
public class Day17Test {
    ...
    private static int simulatePartOne(String input) {
    ...
    private static int simulatePartTwo(String input) {
        Target target = readTarget(input);
        int count = 0;
        for (int vx = 0; vx <= target.xMax(); ++vx) {
            for (int vy = -100; vy < 100; ++vy) {
    ...
    @Test
    void inputExample() {
        assertThat(simulatePartOne("target area: x=20..30, y=-10..-5")).isEqualTo(45);
        assertThat(simulatePartTwo("target area: x=20..30, y=-10..-5")).isEqualTo(112);
    }
    ...
    void inputPartOne() throws IOException {
        try (InputStream is = Day17Test.class.getResourceAsStream("/2021/day/17/input")) {
            ...
            assertThat(simulatePartOne(scanner.nextLine())).isEqualTo(3160);
        }
    }
    ...
    void inputPartTwo() throws IOException {
        try (InputStream is = Day17Test.class.getResourceAsStream("/2021/day/17/input")) {
            Scanner scanner = new Scanner(Objects.requireNonNull(is));
            assertThat(simulatePartTwo(scanner.nextLine())).isEqualTo(1928);
        }
    }
