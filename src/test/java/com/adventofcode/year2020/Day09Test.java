...
public class Day09Test {
    ...
    LongList findContiguousSet(LongList codes, long value) {
    ...
    OptionalLong findEncodingError(LongList codes, int preamble) {
    ...
    void testEncodingError() {
        ...
        LongList contiguousSet = findContiguousSet(codes, 127);
    ...
    void inputEncodingError() throws IOException {
        ...
        LongList contiguousSet = findContiguousSet(codes, encodingError.getAsLong());
