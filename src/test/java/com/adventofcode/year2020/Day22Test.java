...
public class Day22Test {
    ...
    void inputCrabCombat() {
        Scanner scanner = new Scanner(Day22Test.class.getResourceAsStream("/2020/day/22/input"));

        long point = playCrabCombat(scanner);
        assertThat(point).isEqualTo(33393);

        long recursiveCombat = playRecursiveCombat(new Scanner(Day21Test.class.getResourceAsStream("/2020/day/22/input")));
