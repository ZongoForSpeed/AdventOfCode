...
public class Day12Test {
    ...
    void testFirstExample() {
        List<Moon> moons = Stream.of(
                ...
                "<x=2, y=-10, z=-7>",
                "<x=4, y=-8, z=8>",
                "<x=3, y=5, z=-1>").map(Moon::parse).toList();
    ...
    void testSecondExample() {
        List<Moon> moons = Stream.of(
                ...
                "<x=5, y=5, z=10>",
                "<x=2, y=-7, z=3>",
                "<x=9, y=-8, z=-3>").map(Moon::parse).toList();
    ...
    void testInputPartOne() throws IOException {
        List<Moon> moons = FileUtils.readLines("/2019/day/12/input").stream().map(Moon::parse).toList();
    ...
    void testDriftingFirstExample() {
        ...
        List<Moon> moonCopyList = moons.stream().map(Moon::new).toList();
