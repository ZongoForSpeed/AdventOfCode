...
class Day22Test {
    ...
    private static IntList dealIntoNewStack(IntList cards) {
        IntList result = new IntArrayList(cards);
        Collections.reverse(result);
        return result;
    }

    private static IntList cutCards(IntList cards, int n) {
    ...
    private static IntList dealWithIncrement(IntList cards, int n) {
    ...
    private static IntList slamShuffle(IntList cards, List<String> commands) {
    ...
    void testDealIntoNewStack() {
        ...
        assertThat(dealIntoNewStack(cards).toIntArray()).containsExactly(9, 8, 7, 6, 5, 4, 3, 2, 1, 0);
    }

    @Test
    void testCutCards() {
        IntList cards = IntArrayList.toList(IntStream.range(0, 10));
        assertThat(cutCards(cards, 3).toIntArray()).containsExactly(3, 4, 5, 6, 7, 8, 9, 0, 1, 2);
        assertThat(cutCards(cards, -4).toIntArray()).containsExactly(6, 7, 8, 9, 0, 1, 2, 3, 4, 5);
    }

    @Test
    void testDealWithIncrement() {
        IntList cards = IntArrayList.toList(IntStream.range(0, 10));
        assertThat(dealWithIncrement(cards, 3).toIntArray()).containsExactly(0, 7, 4, 1, 8, 5, 2, 9, 6, 3);
    }
    ...
    void testSimpleExample1() {
        ...
        IntList cards = IntArrayList.toList(IntStream.range(0, 10));
        IntList shuffle = slamShuffle(cards, commands);
    ...
    void testSimpleExample2() {
        ...
        IntList cards = IntArrayList.toList(IntStream.range(0, 10));
        assertThat(slamShuffle(cards, commands).toIntArray()).containsExactly(3, 0, 7, 4, 1, 8, 5, 2, 9, 6);
    }
    ...
    void testSimpleExample3() {
        ...
        IntList cards = IntArrayList.toList(IntStream.range(0, 10));
        assertThat(slamShuffle(cards, commands).toIntArray()).containsExactly(6, 3, 0, 7, 4, 1, 8, 5, 2, 9);
    }
    ...
    void testSimpleExample4() {
        ...
        IntList cards = IntArrayList.toList(IntStream.range(0, 10));
        assertThat(slamShuffle(cards, commands).toIntArray()).containsExactly(9, 2, 5, 8, 1, 4, 7, 0, 3, 6);
    }
