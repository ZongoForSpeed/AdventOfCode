...
public class Day01Test {
    ...
    void massOfInput() throws IOException {
        ...
        assertThat(lines.stream().mapToLong(Long::valueOf).map(Day01Test::fuelRequirements).sum()).isEqualTo(3369286);
        assertThat(lines.stream().mapToLong(Long::valueOf).map(Day01Test::sumFuelRequirements).sum()).isEqualTo(5051054);
    }
}
