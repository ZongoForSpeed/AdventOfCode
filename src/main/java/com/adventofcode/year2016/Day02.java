...
public final class Day02 {
     ...
     */
    public static String findCodePartOne(Scanner scanner) {
    ...
    public static String findCode(Scanner scanner, CharMap grid) {
     ...
     */
    public static String findCodePartTwo(Scanner scanner) {
        CharMap grid = CharMap.read("""
                  1
                 234
                56789
