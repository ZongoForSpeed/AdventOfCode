...
public final class Day05 {
     ...
     * produce?
     */
    public static long diagnosticPartOne(String line) {
        return Intcode.ioIntcode(line, 1);
    }
     ...
     */
    public static long diagnosticPartTwo(String line) {
        return Intcode.ioIntcode(line, 5);
    }
}
