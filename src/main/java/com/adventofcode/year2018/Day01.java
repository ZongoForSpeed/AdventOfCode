...
public final class Day01 {
     ...
     */
    static long addFrequencies(Scanner scanner) {
        long frequency = 0;
     ...
     */
    static long findDuplicateFrequency(Scanner scanner) {
        LongList changes = new LongArrayList();
        while (scanner.hasNextLine()) {
            String line = scanner.nextLine();
        ...
        long frequency = 0;
        LongSet frequencies = new LongOpenHashSet();
