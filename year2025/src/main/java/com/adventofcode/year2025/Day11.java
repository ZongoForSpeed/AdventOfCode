...
public final class Day11 {
    ...
    static long reactorPartOne(Scanner scanner) {
        var nextServers = readInput(scanner);
    ...
    static long reactorPartTwo(Scanner scanner) {
        ...
        var dacToFft = findPaths(nextServers, "dac", "fft");
        var fftToDac = findPaths(nextServers, "fft", "dac");
    ...
    private static Map<String, List<String>> readInput(Scanner scanner) {
        var nextServers = new HashMap<String, List<String>>();
        while (scanner.hasNextLine()) {
            ...
            var outputs = new ArrayList<String>(Arrays.asList(splitted).subList(1, splitted.length));
