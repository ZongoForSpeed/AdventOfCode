...
class Day20Test extends AbstractTest {
    ...
    void inputExample() {
        ...
        try (var scanner = new Scanner(input)) {
            var countCheats = Day20.partOne(scanner, 20);
            assertThat(countCheats).isEqualTo(5);
        }

        try (var scanner = new Scanner(input)) {
            var countCheats = Day20.partTwo(scanner, 50);
