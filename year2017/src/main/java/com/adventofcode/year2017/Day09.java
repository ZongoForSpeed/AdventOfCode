...
public final class Day09 {
    ...
    private static IntegerPair streamProcessing(String input) {
        int score = 0;
        ...
        LOGGER.info("score: {}, garbageCount: {}", score, garbageCount);
        return IntegerPair.of(score, garbageCount);
    }
    ...
    static int score(String input) {
        IntegerPair pair = streamProcessing(input);
        return pair.left();
    }
     ...
     */
    static int garbageCount(String input) {
        IntegerPair pair = streamProcessing(input);
        return pair.right();
    }
}
