...
public final class Day15 {
    ...
    private static long generator(long value, long seed) {
        return (value * seed) % 2147483647;
    }

    private static long generatorAPartOne(long value) {
        return generator(value, 16807);
    }

    private static long generatorAPartTwo(long value) {
        do {
            value = generatorAPartOne(value);
        } while (value % 4L != 0L);
        return value;
    }

    private static long generatorBPartOne(long value) {
        return generator(value, 48271);
    }

    private static long generatorBPartTwo(long value) {
        do {
            value = generatorBPartOne(value);
        } while (value % 8L != 0L);
        return value;
    }
     ...
     */
    static long countPairsPartOne(long a, long b) {
        long match = Long.parseLong("1111111111111111", 2);
     ...
     */
    static long countPairsPartTwo(long a, long b) {
        long match = Long.parseLong("1111111111111111", 2);
