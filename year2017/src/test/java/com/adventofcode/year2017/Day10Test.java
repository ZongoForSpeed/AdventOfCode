...
class Day10Test extends AbstractTest {
    ...
    @Test
    void inputExample() {
        assertThat(KnotHash.sparseHash("3,4,1,5", 5)).isEqualTo(12);

        assertThat(KnotHash.knotHash("")).isEqualTo("a2582a3a0e66e6e86e3812dcb672a272");
        assertThat(KnotHash.knotHash("AoC 2017")).isEqualTo("33efeb34ea91902bb2f59c9920caa6cd");
        assertThat(KnotHash.knotHash("1,2,3")).isEqualTo("3efbe78a8d82f29979031a4aa0b16a9d");
        assertThat(KnotHash.knotHash("1,2,4")).isEqualTo("63960835bcdc130f0b66d7ff4f6a5a8e");
    }
    ...
    public void partOne(Scanner scanner) {
        var hash = KnotHash.sparseHash(scanner.nextLine(), 256);
